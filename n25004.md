...
```txt
解答欄
aspmx.l.google.com has address 64.233.187.27
...
HTTP/2 200 
server: nginx
date: Wed, 26 Nov 2025 05:25:36 GMT
...
```txt
解答欄  
nc class_Network 5555 < README.md
```
...
```txt
解答欄  
DNSの設定やPINGがどのような仕組みになっているか学べました。
また、違うネットワークの通信を接続したり、セキュアなssl,tls
通信protocol tcp,udpについて学びました。
```
