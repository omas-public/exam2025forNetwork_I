...
HTTP/2 200 
server: nginx
date: Wed, 26 Nov 2025 05:35:35 GMT
...
```bash
解答欄
sudo ip netns exec p1 ip address add 172.31.0.1/24 dev veth-p1-r1
```
#### r1の設定

```bash
解答欄  
sudo ip netns exec r1 ip address add 172.31.0.254/24 dev veth-r1-p1
```
#### r2の設定   
