...
HTTP/2 200
server: nginx
date:Web, 26 Nov 2025 05:52:09 GMT
...
sudo ip netns exec p1 ip route addd 172.31.0.192/26 via 172.31.0.127
```
#### r1の設定
...
```txt
解答欄  
wiresharkでARPのやり取りをやってみたときよくわからない数字がいっぱいあって、
解析してみるといろいろアドレスとかタイプなど書かれていたことがわかった。
```
