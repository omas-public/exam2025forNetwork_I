...
sudo ip netns exec p1 ip route add 172.31.0.65 via 172.31.0.126
```
#### r1の設定
...
sudo ip netns exec r1 ip route add 172.31.0.126 via 172.31.0.190
```
#### r2の設定   
...
sudo ip netns exec r2 ip route add 172.31.0.190 via 172.31.0.126
```
#### p2の設定   
...
sudo ip netns exec p2 ip route add 172.31.0.193 via 172.31.0.190
```
